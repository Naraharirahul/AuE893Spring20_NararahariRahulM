...
def callback(data):
    ...
    right_sweep = filtered_sweep[300:340]
    left_sweep = filtered_sweep[0:60]
    print('rrigh',right_sweep)
    ...
    print('rrigh',right_sweep)
    print('legft',left_sweep)
    # print(error)
    # Define controller gains
    kp = 0.4 #rospy.get_param('kp') #0.4
    kd = 0.3 #rospy.get_param('kd') #0.3
    speed = 0.2 #rospy.get_param('speed') #0.2
